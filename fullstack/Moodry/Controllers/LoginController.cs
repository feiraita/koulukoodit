...
namespace Phase7.Controllers {
    public class LoginController : Controller {
        ...
        public async Task<IActionResult> Register(AuthViewModel vm) {
            ...
            var user = new User {
                username = vm.Register.username.ToLower(),
                activities = DatabaseManipulator.GetDefaultActivities()
            };
        ...
        public async Task<IActionResult> Login(AuthViewModel vm) {
            ...
            var user = DatabaseManipulator
                .GetSingleByParameter<User>("User", "username", vm.Login.username);
